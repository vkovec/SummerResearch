...
plt.legend()
plt.title("# of States Taking First Set of Options over Time")
plt.xlabel("Trial")
plt.ylabel("# of States taking Option")
plt.show()
#fig.savefig('good.png')
fig.savefig('set1.svg', format='svg', dpi=1200)
...
plt.legend()
plt.title("# of States Taking Second Set of Options over Time")
plt.xlabel("Trial")
plt.ylabel("# of States taking Option")
plt.show()
#fig.savefig('bad.png')
fig.savefig('set2.svg', format='svg', dpi=1200)
